...
const gooseGallery = [
  { url: gooseCover.url, caption: "Full robot render", fit: "cover" as const },
...
const bechtelGallery = [
  ...
  { url: bechtelVideo.url, caption: "Fusion 360 CAM setup for 3-axis mill training part", type: "video" as const },
];
...
const projects: Project[] = [
  ...
  },
  {
    ...
    tag: "R&D Intern · Colex Finishing Solutions",
    desc: "Designed a compact, multi-station tool-head assembly with an integrated router for Colex's next-generation flagship CNC machine — achieving a 3x faster Z-axis jump for high-speed cutting across a ~10,000-unit production run. Improved tool holding rigidity and concentricity for cleaner cuts, validated through 3D-printed and machined prototypes.",
    compact: true,
  },
  {
    n: "05",
...
const experience = [
  {
    role: "Undergraduate Researcher — Underwater Robot Project (Patent Pending)",
  ...
  {
    role: "Project Lead — 6 DOF Underwater Robotic Arm Project",
    org: "MARS Research Lab — Purdue University",
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="mt-6 flex items-center gap-4 md:gap-6">
            ...
            <img
              src={headshot.url}
              alt="Craig Hillyer"
              className="h-16 w-12 rounded-2xl border border-border object-cover shadow-lg md:h-20 md:w-16 lg:h-28 lg:w-20"
            />
          </div>
